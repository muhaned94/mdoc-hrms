    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {orders.length === 0 ? (
          ...
          orders.map(order => (
            <div key={order.id} className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow flex items-start justify-between group">
              <div className="flex gap-4">
                <div className="bg-sky-50 text-sky-600 p-3 rounded-lg h-fit">
                  <FileText size={24} />
                </div>
                <div>
