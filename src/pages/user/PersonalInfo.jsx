...
import { formatDate, calculateServiceDuration, calculateActualService } from '../../utils/dateUtils'
                    ...
                    <div className="px-6 pb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-100 dark:border-slate-700 pt-4 mt-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs text-slate-400 dark:text-slate-500">الخدمة الفعلية</p>
                                    <p className="font-bold text-sm text-blue-600 dark:text-blue-400">{calculateActualService(employee.hire_date).display}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <div className="space-y-4">
                            ...
                            {employee.graduation_certificate_url && (
                                <button onClick={() => setViewFile({ url: employee.graduation_certificate_url, title: 'وثيقة التخرج' })} className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-600 mt-2 text-primary dark:text-sky-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors cursor-pointer w-full">
                                    <Eye size={18} />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {letters.map(letter => (
                                <div key={letter.id} className="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/10 rounded-xl border border-amber-100 dark:border-amber-900/30">
                                    ...
                                    <button onClick={() => setViewFile({ url: letter.file_url, title: letter.title })} className="bg-white dark:bg-slate-700 text-amber-600 dark:text-amber-400 p-2 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-bold">
                                        عرض الكتاب
                                    </button>
                                </div>
                            ))}
