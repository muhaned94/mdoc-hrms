...
import { Download, DollarSign, TrendingUp, CreditCard, FileText, Wallet, Eye } from 'lucide-react'
              ...
              <div className="divide-y divide-slate-100 dark:divide-slate-700">
                {slips.map((slip) => (
                  <div key={slip.id} className="p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <button
                      onClick={() => setViewFile({ url: slip.file_url, title: slip.month_year ? formatMonthYear(slip.month_year) : 'شريط راتب' })}
