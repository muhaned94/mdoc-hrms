        ...
        {messages.length === 0 ? (
          ...
          messages.map(msg => (
            <div
              ...
              className={`bg-white p-6 rounded-2xl shadow-sm border transition-all duration-200 cursor-pointer ${msg.is_read ? 'border-slate-100 opacity-75 hover:opacity-100' : 'border-primary/30 ring-1 ring-primary/10 shadow-md'
                }`}
            >
